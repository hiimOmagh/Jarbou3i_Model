# Release Candidate Handoff — 2.0.0-bio-rc.17

This release candidate completes the automated intersection-audit layer around the Strategic and Biopolitical workbench and makes sample topics follow the selected interface language by default. RC 12 adds portable citation sanitation and a modular, truthful Biopolitical report; RC 13 preserves authored French punctuation; RC 14 completes 320px containment; RC 15 corrects Chromium runner shutdown; RC 16 safely downgrades unsupported full-verification claims into disclosed, publication-blocked review states and hardens WebKit CI interaction synchronization; RC 17 closes the remaining Firefox/Linux Spatial saved-view activation race. The Strategic v1.1 engine and canonical Biopolitical Training Map v2.1 schema remain unchanged. Lossless export and the strict verified-provenance gate remain intact.
