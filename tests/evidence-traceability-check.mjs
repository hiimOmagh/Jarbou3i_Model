...
const manifest = bioIndex.traceability.manifest({ appVersion: "2.1.0-alpha.37", language: "en" });
...
assert(manifest.app_version === "2.1.0-alpha.37", "manifest version missing");
