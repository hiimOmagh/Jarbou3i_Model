...
const manifest = bioIndex.traceability.manifest({ appVersion: "2.1.0-alpha.34", language: "en" });
...
assert(manifest.app_version === "2.1.0-alpha.34", "manifest version missing");
